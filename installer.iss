; Inno Setup script for Color Picker
; Build:  ISCC.exe installer.iss   ->  Output\ColorPicker-Setup.exe
...
[Files]
Source: "dist\ColorPicker.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Root: HKCU; Subkey: "Software\Microsoft\Windows\CurrentVersion\Run"; \
    ValueType: string; ValueName: "ColorPicker"; ValueData: """{app}\{#MyAppExeName}"""; \
...
Type: filesandordirs; Name: "{userappdata}\ColorPicker"
